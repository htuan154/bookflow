// src/api/v1/controllers/reports.controller.js
'use strict';
...
exports.getAdminSummaryReport = async (req, res, next) => {
  try {
    const { date_from, date_to, hotel_filter } = req.query;
    ...
    // Use service to build complete report
...
exports.getAdminPayments = async (req, res, next) => {
  try {
    const { date_from, date_to, hotel_filter, status } = req.query;
