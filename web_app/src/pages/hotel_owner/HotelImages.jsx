...
import { 
    ...
    Eye, Star, Plus, X, AlertCircle, CheckCircle
} from 'lucide-react';
...
const HotelImages = () => {
    ...
    const handleUpload = async () => {
        if (!hotelData?.hotel_id || selectedFiles.length === 0) {
        ...
        try {
            ...
            await uploadHotelImages(hotelData.hotel_id, selectedFiles);
    ...
    const handleDeleteImage = async (imageId) => {
        ...
        try {
            await deleteHotelImage(hotelData.hotel_id, imageId);
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="bg-white rounded-lg shadow p-6">
                <div className="flex items-center justify-between mb-4">
                    <h2 className="text-xl font-semibold text-gray-900">
                        Ảnh hiện tại ({hotelData.images?.length || 0})
                    </h2>
                </div>
                ...
                {hotelData.images && hotelData.images.length > 0 ? (
                    ...
                    <div className="text-center py-12">
                        ...
                        <p className="text-gray-600">
                            Upload ảnh đầu tiên cho khách sạn của bạn
                        </p>
                    </div>
                )}
            </div>
            ...
            {/* Image Modal */}
            {selectedImageIndex !== null && hotelData.images && (
                <div className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-50">
                    <div className="max-w-4xl max-h-full p-4">
                        <img
                            src={hotelData.images[selectedImageIndex].url || hotelData.images[selectedImageIndex].image_url}
