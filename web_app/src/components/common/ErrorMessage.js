      ...
      <div className="flex">
        ...
        <div className="ml-3 flex-1">
          ...
          <div className={`mt-2 text-sm ${styles.text}`}>
            <p>{message || 'Đã xảy ra lỗi không xác định'}</p>
          </div>
            ...
            <div className="mt-4 flex space-x-3">
              {showRetry && onRetry && (
                <button
                  type="button"
                  onClick={onRetry}
                  className={`inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md ${styles.button} focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500`}
                >
                  Thử lại
                </button>
              )}
          ...
          <div className="ml-auto pl-3">
            <div className="-mx-1.5 -my-1.5">
              <button
                type="button"
                onClick={onClose}
                className={`inline-flex rounded-md p-1.5 ${styles.button} focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500`}
              >
