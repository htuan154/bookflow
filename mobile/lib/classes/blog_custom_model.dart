...
class BlogCustom {
  ...
  factory BlogCustom.fromJson(Map<String, dynamic> json) {
    return BlogCustom(
  ...
  @override
  String toString() {
    return 'BlogCustom(blogId: $blogId, title: $title, status: $status, viewCount: $viewCount, likeCount: $likeCount)';
  }

  @override
  bool operator ==(Object other) {
    if (identical(this, other)) return true;
    return other is BlogCustom && other.blogId == blogId;
  }
